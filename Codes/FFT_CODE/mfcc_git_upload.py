...
def mfcc_compare(database, audio_mfcc):
    ...
    m12345_bottom = np.concatenate((m1_bottom_mfcc1,m2_bottom_mfcc1,m3_bottom_mfcc1, m4_bottom_mfcc1, m5_bottom_mfcc1))
    ...
    for sample in database:                                   #Perform a one-to-one comparison between the database and the loaded audio file (m12345_bottom)
        ...
        if ((m12345_bottom[i]-fdrift)<=sample<=(m12345_bottom[i]+fdrift)):
    ...
    if len(match)>= len(m12345_bottom)*0.8:                                           #as we increase 0.8, we increase the accuracy expectation. Right now we want 80% of the data match with database
        print('Hello Navid')
    else:
...
def mfcc_database(mfcc_data_1, mfcc_data_2, mfcc_data_3, mfcc_data_4, mfcc_data_5):
    ...
    #print(m1_bottom_total)
    #print(m2_bottom_total)
    #print(m3_bottom_total)
    #print(m4_bottom_total)
    #print(m5_bottom_total)
...
def main():
    ...
    mfcc_coef_audio1, len_mfcc_audio1 = mfcc_process('uzi_1')         
    mfcc_coef_audio2, len_mfcc_audio2 = mfcc_process('uzi_2')
    mfcc_coef_audio3, len_mfcc_audio3 = mfcc_process('uzi_3')
    mfcc_coef_audio4, len_mfcc_audio4 = mfcc_process('uzi_4')
    mfcc_coef_audio5, len_mfcc_audio5 = mfcc_process('uzi_5')
